...
def train_clas(
    ...
    <pretrained>: If 0, starts from 0 (with untrained language model).
    ...
    learner = clas_learner(data_lm, AWD_LSTM, model_dir, pretrained=pretrained, config=model_hparams, metrics=metrics)
